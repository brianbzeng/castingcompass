...
test("authorization is exact, staging-only, synthetic-only, provider-isolated, and disjoint", () => {
  ...
  for (const invalid of [
    ...
    authorization({ safety: { synthetic_data_only: false } }),
    authorization({ safety: { production_bindings_attached: true } }),
    authorization({ safety: { production_user_data_accessible: true } }),
