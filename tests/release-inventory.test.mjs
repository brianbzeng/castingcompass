...
const inputPaths = [
  ...
  "contracts/exploratory-collection-plan.schema.json",
  ...
  "contracts/model-input-contract.schema.json",
  "contracts/model-selection-plan.schema.json",
  ...
  "model/selection/california-halibut-input-v1.json",
  "model/selection/california-halibut-v1.json",
  "model/collection/santa-barbara-goleta-exploratory-v1.json",
