...
test("patched build-tool versions are exact and remain above the reviewed advisory floors", () => {
  ...
  assert.equal(packageJson.devDependencies["@cloudflare/vite-plugin"], "1.52.1");
  ...
  assert.equal(lock.packages["node_modules/miniflare"].version, "5.20260811.1-alpha");
  assert.equal(lock.packages["node_modules/workerd"].version, "1.20260811.1");
