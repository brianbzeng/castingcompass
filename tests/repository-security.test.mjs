...
test("patched build-tool versions are exact and remain above the reviewed advisory floors", () => {
  ...
  assert.equal(packageJson.devDependencies["@cloudflare/vite-plugin"], "1.47.0");
  ...
  assert.equal(lock.packages["node_modules/miniflare"].version, "4.20260722.0");
  assert.equal(lock.packages["node_modules/workerd"].version, "1.20260722.1");
