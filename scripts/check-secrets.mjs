...
const rules = [
  {
    ...
    pattern: signature(
      "\\b(?:CLOUDFLARE_API_TOKEN|CF_API_TOKEN|MIMO_API_KEY|RESEND_API_KEY|TURNSTILE_SECRET_KEY|RATE_LIMIT_KEY_SECRET|VALIDATION_PARTICIPANT_HMAC_SECRET|VALIDATION_RECRUITMENT_HMAC_SECRET|OPENAI_API_KEY|AWS_SECRET_ACCESS_KEY|GITHUB_TOKEN|NPM_TOKEN)",
      "[\\\"']?[\\t ]*[:=][\\t ]*[\\\"']?",
