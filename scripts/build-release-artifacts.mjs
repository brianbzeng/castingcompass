...
const sourcePaths = [
  ...
  ["security/production-worker-secret-bindings.json", "security/production-worker-secret-bindings.json"],
  ["security/npm-audit-policy.json", "security/npm-audit-policy.json"],
  ["security/npm-install-policy.json", "security/npm-install-policy.json"],
  ["scripts/verify-npm-audit-policy.mjs", "scripts/verify-npm-audit-policy.mjs"],
...
export function verifyReleaseArtifacts({ outputDirectory, commitSha, repository }) {
  ...
  const requiredEntries = [
    ...
    `${RELEASE_PREFIX}/security/production-worker-secret-bindings.json`,
    ...
    `${RELEASE_PREFIX}/field-review/oakland-south-bay-structure-depth-review-policy.json`,
