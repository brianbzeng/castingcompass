...
all 245 direct `.prepare()` sites: 231 literal statements and 14 separately reviewed nonliteral
...
database, runs 40 representative `EXPLAIN QUERY PLAN` checks, and rejects missing leftmost
