# San Francisco structure and depth review packet
...
for the 10 San Francisco coast and waterfront catalog locations. It does not ask
...
npm run write:san-francisco-structure-depth-review-template -- --output-file /absolute/private/path/structure-depth-review.json --expected-commit <full-commit-sha>
```
...
```sh
npm run evaluate:san-francisco-structure-depth-review -- --evidence-file /absolute/private/path/structure-depth-review.json --expected-commit <full-commit-sha>
```
...
- `torpedo-wharf` — **Torpedo Wharf**
- `crissy-field-east-beach` — **Crissy Field East Beach**
- `baker-beach` — **Baker Beach**
- `china-beach` — **China Beach**
- `ocean-beach-north` — **Ocean Beach North**
- `ocean-beach-south` — **Ocean Beach South**
- `pier-7` — **Pier 7**
- `pier-14` — **Pier 14**
- `crane-cove-park` — **Crane Cove Park**
- `herons-head-park-pier` — **Heron's Head Park Pier**
