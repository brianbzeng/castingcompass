...
export type ApiHandler = "health" | "turnstile" | "account" | "trips" | "discussions" | "community";
...
export const API_ROUTE_PATTERNS = {
  communityBlock: /^\/api\/community\/blocks\/([a-z0-9_]{3,24})$/,
  communityComment: /^\/api\/community\/comments\/(ccomment_[a-f0-9-]{36})$/,
  communityPost: /^\/api\/community\/posts\/(cpost_[a-f0-9-]{36})$/,
  communityPostComments: /^\/api\/community\/posts\/(cpost_[a-f0-9-]{36})\/comments$/,
  communityPreview: /^\/api\/community\/([a-z0-9-]+)\/preview$/,
  communitySite: /^\/api\/community\/(?!profile$|reports$|posts$|comments$|blocks$)([a-z0-9-]+)$/,
...
export const API_ROUTE_POLICIES: readonly ApiRoutePolicy[] = [
  ...
  route(
    "community.preview",
    "/api/community/{siteId}/preview",
    "/api/community/ocean-beach/preview",
    ["GET"],
    "public",
    "community",
    { matches: (path) => API_ROUTE_PATTERNS.communityPreview.test(path) },
  ),
  route(
  ...
  route(
    "community.site.read",
    "/api/community/{siteId}",
    "/api/community/ocean-beach",
    ["GET"],
    "owner",
    "community",
    {
      currentLegalAcceptanceRequired: true,
      matches: (path) => API_ROUTE_PATTERNS.communitySite.test(path),
    },
  ),
  route(
    ...
    ownerMutation.authorization,
    "community",
    { ...ownerMutation, matches: (path) => API_ROUTE_PATTERNS.communitySite.test(path) },
  ),
  route(
    "community.post.update",
    "/api/community/posts/{postId}",
    "/api/community/posts/cpost_00000000-0000-4000-8000-000000000000",
    ["PATCH"],
    ownerMutation.authorization,
    "community",
    { ...ownerMutation, matches: (path) => API_ROUTE_PATTERNS.communityPost.test(path) },
  ),
  route(
  ...
  route(
    "community.comments.read",
    "/api/community/posts/{postId}/comments",
    "/api/community/posts/cpost_00000000-0000-4000-8000-000000000000/comments",
    ["GET"],
    "owner",
    "community",
    {
      currentLegalAcceptanceRequired: true,
      matches: (path) => API_ROUTE_PATTERNS.communityPostComments.test(path),
    },
  ),
  route(
    ...
    ownerMutation.authorization,
    "community",
    { ...ownerMutation, matches: (path) => API_ROUTE_PATTERNS.communityPostComments.test(path) },
  ),
  route(
    "community.comment.update",
    "/api/community/comments/{commentId}",
    "/api/community/comments/ccomment_00000000-0000-4000-8000-000000000000",
    ["PATCH"],
    ownerMutation.authorization,
    "community",
    { ...ownerMutation, matches: (path) => API_ROUTE_PATTERNS.communityComment.test(path) },
  ),
  route(
  ...
  route(
    "community.block.create",
    "/api/community/blocks/{handle}",
    "/api/community/blocks/example_handle",
    ["PUT"],
    ownerMutation.authorization,
    "community",
    { ...ownerMutation, rateLimitTags: ["sensitive"], matches: (path) => API_ROUTE_PATTERNS.communityBlock.test(path) },
  ),
  route(
    "community.block.delete",
    "/api/community/blocks/{handle}",
    "/api/community/blocks/example_handle",
    ["DELETE"],
    ownerMutation.authorization,
...
const REVIEWED_PUBLIC_API_ROUTE_CONTRACTS: Readonly<Record<string, ReviewedPublicApiRouteContract>> = {
  ...
  "community.preview": {
    pathTemplate: "/api/community/{siteId}/preview",
    pathPattern: /^\/api\/community\/[a-z0-9-]+\/preview$/,
    methods: ["GET"],
    handler: "community",
    sameOriginRequired: false,
    rateLimitTags: [],
...
const REVIEWED_OWNER_API_ROUTE_CONTRACTS: Readonly<Record<string, ReviewedOwnerApiRouteContract>> = {
  ...
  "community.profile.read": {
    pathTemplate: "/api/community/profile",
    pathPattern: /^\/api\/community\/profile$/,
    methods: ["GET"],
    handler: "community",
    sameOriginRequired: false,
    currentLegalAcceptanceRequired: true,
  ...
  "community.site.read": {
    pathTemplate: "/api/community/{siteId}",
    pathPattern: /^\/api\/community\/(?!profile$|reports$|posts$|comments$|blocks$)[a-z0-9-]+$/,
    methods: ["GET"],
    handler: "community",
    sameOriginRequired: false,
    currentLegalAcceptanceRequired: true,
  ...
  "community.post.update": {
    pathTemplate: "/api/community/posts/{postId}",
    pathPattern: /^\/api\/community\/posts\/cpost_[a-f0-9-]{36}$/,
    methods: ["PATCH"],
    handler: "community",
    sameOriginRequired: true,
    currentLegalAcceptanceRequired: true,
  ...
  "community.comment.create": {
    pathTemplate: "/api/community/posts/{postId}/comments",
    pathPattern: /^\/api\/community\/posts\/cpost_[a-f0-9-]{36}\/comments$/,
    methods: ["POST"],
    handler: "community",
    sameOriginRequired: true,
    currentLegalAcceptanceRequired: true,
  ...
  "community.comment.update": {
    pathTemplate: "/api/community/comments/{commentId}",
    pathPattern: /^\/api\/community\/comments\/ccomment_[a-f0-9-]{36}$/,
    methods: ["PATCH"],
    handler: "community",
    sameOriginRequired: true,
    currentLegalAcceptanceRequired: true,
  ...
  "community.report.create": {
    pathTemplate: "/api/community/reports",
    pathPattern: /^\/api\/community\/reports$/,
    methods: ["POST"],
    handler: "community",
    sameOriginRequired: true,
    currentLegalAcceptanceRequired: true,
  ...
  "community.block.create": {
    pathTemplate: "/api/community/blocks/{handle}",
    pathPattern: /^\/api\/community\/blocks\/[a-z0-9_]{3,24}$/,
    methods: ["PUT"],
    handler: "community",
    sameOriginRequired: true,
    currentLegalAcceptanceRequired: true,
